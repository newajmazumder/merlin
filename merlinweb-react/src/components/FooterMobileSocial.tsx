...
export default function FooterMobileSocial() {
  return (
    <div
      className="m-8bffd616 mantine-Flex-root __m__-«R2brdivdb» mantine-hidden-from-md"
      style={wrapperStyle}
    >
      <div className="m-8bffd616 mantine-Flex-root __m__-«Rdmbrdivdb»" style={innerFlexStyle}>
        <a href="https://x.com/merlincomputer" rel="noopener noreferrer" target="_blank">
          <svg
            color="#808080"
            fill="currentColor"
            height="18"
      ...
      <p className="mantine-focus-auto m-b6d8b162 mantine-Text-root" style={copyrightStyle}>
